...
export default function Footer() {
  return (
    <Flex mb='0' bottom='0'  display='block' justifyContent='center' align='center' ml='auto' h='100' w='100%' bgColor='gray.50'>
      ...
      <Flex mb='5' justifyContent='space-between' mt='2' alignItems='center'>
        ...
        <Box display='flex' mr='3' alignItems='center' justifyContent='center' >
          ...
          <Icon color='black' fontWeight='bold' fontSize='2xl'  _hover={{color:"gray.900"}}><FaInstagram/></Icon>
          </Link>
          <Link color='black'  textDecoration='none' mr='3' >
          <Icon color='black' fontSize='2xl'  _hover={{color:"gray.900"}}><FaFacebookSquare/></Icon>
          </Link>
          <Link color='black' textDecoration='none' mr='3' >
          <Icon color='black' fontSize='2xl'  _hover={{color:"gray.900"}}><FaYoutube /></Icon>
          </Link>
        </Box>
      </Flex>
